...
import Clipped from "../assets/icon-12px-solid/clipped.svg";
import CloseX from "../assets/icon-12px-solid/close-x.svg";
import Delay from "../assets/icon-12px-solid/delay.svg";
import Dot from "../assets/icon-12px-solid/dot.svg";
import DropdownArrow from "../assets/icon-12px-solid/dropdown-arrow.svg";
import Edit12px from "../assets/icon-12px-solid/edit-12px.svg";
import Empty12px from "../assets/icon-12px-solid/empty-12px.svg";
import Failure from "../assets/icon-12px-solid/failure.svg";
...
import GridDotted from "../assets/icon-12px-solid/grid-dotted.svg";
...
import License12px from "../assets/icon-12px-solid/license-12px.svg";
...
import RenderModeNormal from "../assets/icon-12px-solid/render-mode-normal.svg";
import RenderModeOutline from "../assets/icon-12px-solid/render-mode-outline.svg";
import RenderModePixels from "../assets/icon-12px-solid/render-mode-pixels.svg";
import RenderModeSvg from "../assets/icon-12px-solid/render-mode-svg.svg";
import Snapping from "../assets/icon-12px-solid/snapping.svg";
import SwapHorizontal from "../assets/icon-12px-solid/swap-horizontal.svg";
import SwapVertical from "../assets/icon-12px-solid/swap-vertical.svg";
...
import WorkingColors from "../assets/icon-12px-solid/working-colors.svg";
...
import Artboard from "../assets/icon-16px-solid/artboard.svg";
import BooleanDifference from "../assets/icon-16px-solid/boolean-difference.svg";
import BooleanDivide from "../assets/icon-16px-solid/boolean-divide.svg";
...
import Bug from "../assets/icon-16px-solid/bug.svg";
...
import CloseAll from "../assets/icon-16px-solid/close-all.svg";
import Close from "../assets/icon-16px-solid/close.svg";
import Code from "../assets/icon-16px-solid/code.svg";
import Copy from "../assets/icon-16px-solid/copy.svg";
import Credits from "../assets/icon-16px-solid/credits.svg";
import CustomColor from "../assets/icon-16px-solid/custom-color.svg";
import Cut from "../assets/icon-16px-solid/cut.svg";
import DeselectAll from "../assets/icon-16px-solid/deselect-all.svg";
import Edit from "../assets/icon-16px-solid/edit.svg";
import Empty from "../assets/icon-16px-solid/empty.svg";
import EyeHidden from "../assets/icon-16px-solid/eye-hidden.svg";
import EyeHide from "../assets/icon-16px-solid/eye-hide.svg";
import EyeShow from "../assets/icon-16px-solid/eye-show.svg";
...
import FileExport from "../assets/icon-16px-solid/file-export.svg";
import FileImport from "../assets/icon-16px-solid/file-import.svg";
...
import FolderOpen from "../assets/icon-16px-solid/folder-open.svg";
import Folder from "../assets/icon-16px-solid/folder.svg";
import FrameAll from "../assets/icon-16px-solid/frame-all.svg";
import FrameSelected from "../assets/icon-16px-solid/frame-selected.svg";
import GraphViewClosed from "../assets/icon-16px-solid/graph-view-closed.svg";
import GraphViewOpen from "../assets/icon-16px-solid/graph-view-open.svg";
import GraphiteLogo from "../assets/icon-16px-solid/graphite-logo.svg";
import HandleVisibilityAll from "../assets/icon-16px-solid/handle-visibility-all.svg";
import HandleVisibilityFrontier from "../assets/icon-16px-solid/handle-visibility-frontier.svg";
import HandleVisibilitySelected from "../assets/icon-16px-solid/handle-visibility-selected.svg";
import Heart from "../assets/icon-16px-solid/heart.svg";
import HistoryRedo from "../assets/icon-16px-solid/history-redo.svg";
import HistoryUndo from "../assets/icon-16px-solid/history-undo.svg";
import IconsGrid from "../assets/icon-16px-solid/icons-grid.svg";
import Image from "../assets/icon-16px-solid/image.svg";
import Layer from "../assets/icon-16px-solid/layer.svg";
import License from "../assets/icon-16px-solid/license.svg";
import NewLayer from "../assets/icon-16px-solid/new-layer.svg";
...
import Node from "../assets/icon-16px-solid/node.svg";
import PadlockLocked from "../assets/icon-16px-solid/padlock-locked.svg";
import PadlockUnlocked from "../assets/icon-16px-solid/padlock-unlocked.svg";
import Paste from "../assets/icon-16px-solid/paste.svg";
import PinActive from "../assets/icon-16px-solid/pin-active.svg";
import PinInactive from "../assets/icon-16px-solid/pin-inactive.svg";
import PlaybackPause from "../assets/icon-16px-solid/playback-pause.svg";
import PlaybackPlay from "../assets/icon-16px-solid/playback-play.svg";
import PlaybackToEnd from "../assets/icon-16px-solid/playback-to-end.svg";
import PlaybackToStart from "../assets/icon-16px-solid/playback-to-start.svg";
...
import Resync from "../assets/icon-16px-solid/resync.svg";
import ReverseRadialGradientToLeft from "../assets/icon-16px-solid/reverse-radial-gradient-to-left.svg";
import ReverseRadialGradientToRight from "../assets/icon-16px-solid/reverse-radial-gradient-to-right.svg";
import Reverse from "../assets/icon-16px-solid/reverse.svg";
import Save from "../assets/icon-16px-solid/save.svg";
import SelectAll from "../assets/icon-16px-solid/select-all.svg";
import SelectParent from "../assets/icon-16px-solid/select-parent.svg";
import Settings from "../assets/icon-16px-solid/settings.svg";
import SmallDot from "../assets/icon-16px-solid/small-dot.svg";
import StackBottom from "../assets/icon-16px-solid/stack-bottom.svg";
import StackHollow from "../assets/icon-16px-solid/stack-hollow.svg";
import StackLower from "../assets/icon-16px-solid/stack-lower.svg";
import StackRaise from "../assets/icon-16px-solid/stack-raise.svg";
import StackReverse from "../assets/icon-16px-solid/stack-reverse.svg";
import Stack from "../assets/icon-16px-solid/stack.svg";
import TiltReset from "../assets/icon-16px-solid/tilt-reset.svg";
import Tilt from "../assets/icon-16px-solid/tilt.svg";
import TransformationGrab from "../assets/icon-16px-solid/transformation-grab.svg";
import TransformationRotate from "../assets/icon-16px-solid/transformation-rotate.svg";
import TransformationScale from "../assets/icon-16px-solid/transformation-scale.svg";
import Trash from "../assets/icon-16px-solid/trash.svg";
import TurnNegative90 from "../assets/icon-16px-solid/turn-negative-90.svg";
import TurnPositive90 from "../assets/icon-16px-solid/turn-positive-90.svg";
import UserManual from "../assets/icon-16px-solid/user-manual.svg";
...
import Volunteer from "../assets/icon-16px-solid/volunteer.svg";
import Website from "../assets/icon-16px-solid/website.svg";
import WorkingColorsPrimary from "../assets/icon-16px-solid/working-colors-primary.svg";
import WorkingColorsSecondary from "../assets/icon-16px-solid/working-colors-secondary.svg";
import Zoom1x from "../assets/icon-16px-solid/zoom-1x.svg";
import Zoom2x from "../assets/icon-16px-solid/zoom-2x.svg";
...
import VectorPolygonTool from "../assets/icon-24px-two-tone/vector-polygon-tool.svg";
